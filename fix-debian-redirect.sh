...
# Fix Debian repository redirect issue
# Handle the 302 redirect to ftp.debian.org
...
print_status "Fixing Debian repository redirect issue..."

# Test Debian repository access with redirect handling
print_status "Testing Debian repository access with redirect handling..."
if curl -L -f http://deb.debian.org/debian/ > /dev/null 2>&1; then
    print_success "Debian repository accessible with redirect"
else
